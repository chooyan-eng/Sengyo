...
class FixedSizeImage extends StatelessWidget {
  ...
  const FixedSizeImage({Key key, this.imagePath, this.withMask = false, this.child}) : super(key: key);
        ...
        withMask ? Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [Colors.transparent, Colors.black.withAlpha(150), Colors.black.withAlpha(200)]
            ),
          ),
          child: child,
        ) : SizedBox.shrink(),
